        ...
        <div class="orb-page-frame orb-portfolio-1">
            <div class="orb-top-bar-frame">
                <div class="orb-content orb-top-bar">
                    <a href="index.html" class="orb-logo-frame">
                        <!-- image logo <img src="<?= URL . "/public/home/img/ui/logo.svg" ?>" alt="Orabel">-->
                        <!-- svg logo -->
            ...
            <div class="swiper-container orb-slider-3s">
                                ...
                                <div class="orb-g-100 orb-sm-100">
                                    <div class="orb-object-frame">
                                        <div class="orb-photo-frame orb-obj-1">
                                            <img src="<?= URL . '/files/' . $samplework['image']  ?>" alt="عکس" />
                                            <a data-fancybox="gallery" data-no-swup href="<?= URL . '/files/' . $samplework['image']  ?>" class="orb-zoom"><img src="<?= URL . "/public/home/img/ui/zoom.svg" ?>" alt="بزرگنمایی" /></a>
                                        </div>
                                        <div class="orb-slide-caption">
                                            <h2><?= $samplework['title']  ?></h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="orb-nav-frame">
                    <div class="orb-nav">
                        <div class="orb-nav-label">کار بعدی</div>
                        <div class="orb-prev">
                            <img src="<?= URL . "/public/home/img/ui/arrow-1.svg" ?>" alt="فلش" />
                        </div>
                        <div class="orb-next">
                            <img src="<?= URL . "/public/home/img/ui/arrow-1.svg" ?>" alt="فلش" />
                        </div>
