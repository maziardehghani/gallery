...
<div class="orb-wrapper">
    ...
    <div id="orb-dynamic-content" class="transition-fade">
        <div class="orb-page-frame orb-home-2">
            <div class="orb-top-bar-frame">
                <div class="orb-content orb-top-bar">
                    <a href="<?= URL ?>" class="orb-logo-frame">
                    ...
                    <?php include __DIR__ . '/../layouts/orb_left.php'; ?>
            ...
            <div class="swiper-container orb-banner-slider">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="orb-content">
                            <div class="orb-grid orb-sm-reverse">
                                <div class="orb-g-100">
                                    <div class="rb-object-frame" data-swiper-parallax-opacity="0">
                                        <div class="orb-photo-frame orb-from-top orb-obj-1" data-swiper-parallax="-100"
                                             data-swiper-parallax-scale="1.2">
                                            <img src="<?= URL . "/public/home/img/photo/31.jpg" ?>" alt="عکس"/>
                                        </div>
                                        <div class="orb-slide-caption" data-swiper-parallax="0"
                                             data-swiper-parallax-opacity="0">
                                            <div class="orb-main-title" data-swiper-parallax-y="-200"
                                                 data-swiper-parallax-scale=".8">
                                                <div class="orb-suptitle">
                                                    <span>21 اردیبهشت 1400</span>
                                                </div>
                                                <h1>
                                                    بــــــــــاد <br/>
                                                    تــغــیــیــر
                                            ...
                                            <div class="orb-button-and-descr">
                                                <a href="<?= URL . "/samplework/all" ?>" class="orb-button">
                                                    <div class="orb-arrow">
                                                        <img src="<?= URL . "/public/home/img/ui/arrow-2.svg" ?>"
                                                             alt="فلش"/>
                                                    </div>
                                                    <span>
                                                                نمایش <br/>
                                                ...
                                                <div class="orb-description" data-swiper-parallax="200">
                                                    <span>این یک عکس جالب و شیک با یک فرد منحصر به فرد بود</span>
                            ...
                            <div class="orb-grid orb-sm-reverse">
                                <div class="orb-g-100">
                                    <div class="rb-object-frame" data-swiper-parallax-opacity="0">
                                        <div class="orb-photo-frame orb-from-top orb-obj-1" data-swiper-parallax="-100"
                                             data-swiper-parallax-scale="1.2">
                                            <img src="<?= URL . "/public/home/img/photo/33.jpg" ?>" alt="عکس"/>
                                        </div>
                                        <div class="orb-slide-caption" data-swiper-parallax="0"
                                             data-swiper-parallax-opacity="0">
                                            <div class="orb-main-title" data-swiper-parallax-y="-200"
                                            ...
                                            <div class="orb-button-and-descr">
                                                <a href="portfolio-5.html" class="orb-button">
                                                    <div class="orb-arrow">
                                                        <img src="<?= URL . "/public/home/img/ui/arrow-2.svg" ?>"
                                                             alt="فلش"/>
                                                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="orb-content">
                            <div class="orb-grid orb-sm-reverse" data-swiper-parallax-opacity="0">
                                <div class="orb-g-100">
                ...
                <div class="orb-navigation">
                    ...
                    <div class="orb-nav">
                        <div class="orb-prev">
                            <img src="<?= URL . "/public/home/img/ui/arrow-2.svg" ?>" alt="فلش"/>
                        </div>
                        <div class="orb-next">
                            <img src="<?= URL . "/public/home/img/ui/arrow-2.svg" ?>" alt="فلش"/>
                        </div>
        ...
        <?php include __DIR__ . "/../layouts/big_menu_fram.php" ?>
    </div>
</div>